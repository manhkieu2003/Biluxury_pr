...
const AddProducts={
   async render()
    {
        const {data}= await getAll();  // lấy danh mục để đổ vào phần category
        console.log(data)
       return/*html*/`
           ...
           <div class="max-w-2xl mx-auto bg-white p-8 shadow-lg rounded-lg">
               ...
               <form id="addProduct" class="space-y-4">
                   ...
                   <div>
                       ...
                       <input type="text" id="name-product" class="w-full border border-gray-300 p-2 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Nhập tiêu đề" required/>
                   </div>
                   
                   <!-- Image -->
                   <div>
                       <label for="img-product" class="block text-gray-700 font-medium">Hình ảnh</label>
                       <input type="file" id="img-product" class="w-full border border-gray-300 p-2 rounded-lg focus:outline-none focus:border-blue-500" required/>
                   ...
                   <div>
                       ...
                       <textarea id="desc-product" class="w-full border border-gray-300 p-2 rounded-lg focus:outline-none focus:border-blue-500" cols="30" rows="6" placeholder="Nhập mô tả bài viết" required></textarea>
                   </div>
                   <!-- Color -->
                   <div>
                   <label for="color-product" class="block text-gray-700 font-medium">Màu sắc</label>
                   <input type="text" id="color-product" class="w-full border border-gray-300 p-2 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Nhập màu sắc" required/>
                   </div>

               <!-- Price -->
               <div>
                   <label for="price-product" class="block text-gray-700 font-medium">Giá</label>
                   <input type="number" id="price-product" class="w-full border border-gray-300 p-2 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Nhập giá sản phẩm" required/>
               </div>
                    <!-- Category Selection -->
                    <div>
    ...
    Afterender()
    {
        const formaddPost = document.querySelector("#addProduct")
