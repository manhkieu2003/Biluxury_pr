...
import { Delete, getAll } from "../api/post"
    ...
    
    {
        ...
        ${ await Header.render()}
         ...
         <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
             <h2 class="text-3xl font-bold tracking-tight text-gray-900 mb-6">Post Management</h2>

             <!-- Add New Post Button -->
             <div class="mb-8">
                 <a href="/admin/addpost" class="inline-block px-6 py-3 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700">
                     + Thêm bài viết mới
                 </a>
             </div>
                         ...
                         ${data.map((post, index) => `
                             <tr>
                                 ...
                                 <td class="py-4 px-4 space-x-4">
                                     <a href="/admin/edit/${post.id}" class="text-blue-500 hover:text-blue-700">Sửa</a>
    ...
    //    console.log(id)  
       btn.addEventListener('click',()=>{
        ...
        if (confirm('Bạn có chắc chắn muốn xóa bài viết này không?')) {
            Delete(id).then(() => {
                reRender(DashboardPost, "#content");
            });
        }
